...
public class CircleView extends View{
	...
	public CircleView(Context context, AttributeSet attrs) {
		...
		TypedArray arr = context.obtainStyledAttributes(attrs,R.styleable.it_mapeto2my_circles_square_views_CircleView);
		
		shapeColor = arr.getColor(R.styleable.it_mapeto2my_circles_square_views_CircleView_view_color, Color.YELLOW); /* Colore forma via valore attributo */
